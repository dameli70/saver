...
return [
    ...
    // Recevoir via lien
    'page.receive_link_create' => 'Recevoir via lien',
    'page.receive' => 'Envoyer vers un lien de réception',

    'receive_link_create.page_intro' => 'Générez un lien entrant afin qu’une personne puisse vous envoyer un secret verrouillé dans le temps.',
    'receive_link_create.card_title' => 'Lien entrant',
    'receive_link_create.unavailable' => 'Cette fonctionnalité est indisponible sur ce serveur. Appliquez les migrations (config/migrations/033_inbound_lock_links.sql).',
    'receive_link_create.mode_label' => 'Mode',
    'receive_link_create.mode_recipient_sets' => 'Le destinataire fixe la date de révélation',
    'receive_link_create.mode_sender_sets' => 'L’expéditeur fixe la date de révélation',
    'receive_link_create.max_uses_label' => 'Nombre d’utilisations max',
    'receive_link_create.expires_at_label' => 'Expiration',
    'receive_link_create.btn_create' => 'Générer le lien',
    'receive_link_create.btn_creating' => 'Génération…',
    'receive_link_create.link_label' => 'Lien (à partager)',
    'receive_link_create.note' => 'Zero-knowledge : le secret (en clair) est uniquement dans le fragment du lien (#s=…). Le serveur stocke seulement du texte chiffré et ne peut pas le lire.',
    'receive_link_create.err_passphrase_required' => 'Phrase secrète du coffre requise',
    'receive_link_create.err_reveal_required' => 'Date de révélation requise',
    'receive_link_create.toast_created' => 'Lien créé',
    'receive_link_create.toast_copied' => 'Copié',

    // Réception (expéditeur)
    'receive.page_intro' => 'Collez un secret, chiffrez-le dans votre navigateur, puis envoyez-le au destinataire.',
    'receive.card_title' => 'Envoyer un secret',
    'receive.invalid_link' => 'Lien invalide (token manquant).',
    'receive.err_missing_secret' => 'Secret manquant. Ce lien doit inclure #s=…',
    'receive.label_label' => 'Libellé',
    'receive.label_placeholder' => 'ex. PIN bancaire',
    'receive.secret_label' => 'Secret / code',
    'receive.secret_placeholder' => 'Collez le secret…',
    'receive.btn_submit' => 'Chiffrer et envoyer',
    'receive.btn_submitting' => 'Envoi…',
    'receive.msg_submitted' => 'Envoyé.',
    'receive.err_label_required' => 'Libellé requis',
    'receive.err_plain_required' => 'Secret requis',
    'receive.err_reveal_required' => 'Date de révélation requise',
    'receive.meta_mode_recipient' => 'La date de révélation est fixée par le destinataire',
    'receive.meta_mode_sender' => 'Vous pouvez choisir la date de révélation',
    'receive.meta_reveal_fixed' => 'Révélation (UTC)',
    'receive.meta_uses' => 'Utilisations',
    'receive.meta_expires' => 'Expire',

    // Cadeaux
    'page.gift_create' => 'Cadeau programmé',
    'page.gift' => 'Cadeau',

    'gift_create.page_intro' => 'Créez un message/code cadeau qui se débloquera à une date choisie.',
    'gift_create.card_title' => 'Créer un lien cadeau',
    'gift_create.label_label' => 'Libellé',
    'gift_create.label_placeholder' => 'ex. Joyeux anniversaire',
    'gift_create.message_label' => 'Message / code cadeau',
    'gift_create.message_placeholder' => 'Écrivez votre message ou code…',
    'gift_create.btn_create' => 'Créer le lien cadeau',
    'gift_create.btn_creating' => 'Création…',
    'gift_create.link_label' => 'Lien partageable',
    'gift_create.note' => 'Zero-knowledge : le secret (en clair) est uniquement dans le fragment du lien (#s=…). Le serveur stocke seulement du texte chiffré et ne peut pas le lire.',
    'gift_create.err_plain_required' => 'Message requis',
    'gift_create.err_reveal_required' => 'Date de révélation requise',
    'gift_create.toast_created' => 'Cadeau créé',
    'gift_create.toast_copied' => 'Copié',

    'gift.page_intro' => 'Ce cadeau se débloque à la date de révélation. Le déchiffrement se fait uniquement dans votre navigateur.',
    'gift.card_title' => 'Cadeau',
    'gift.invalid_link' => 'Lien invalide (token manquant).',
    'gift.err_missing_secret' => 'Secret manquant. Ce lien doit inclure #s=…',
    'gift.meta_locked' => 'Verrouillé',
    'gift.meta_unlocked' => 'Déverrouillé',
    ...
    'index.send_timed_gift' => 'Envoyer un cadeau programmé',
    ...
    'index.preview.badge_server' => 'Imposé par le serveur',
    'index.preview.badge_client' => 'Chiffrement côté client',
    'index.preview.badge_reauth' => 'Passkey / TOTP',
    'index.preview.title' => 'Un aperçu du flux',
    'index.preview.sub' => 'Les verrous restent scellés jusqu’à la date. Au bon moment, vous confirmez avec une ré‑authentification forte — puis révélez ou contribuez en confiance.',
    'index.preview.k_label' => 'Élément verrouillé',
    'index.preview.v_label' => 'PIN • Bon • Mot de passe',
    'index.preview.k_state' => 'État',
    'index.preview.v_state' => 'Scellé • Éligible • Révélé',
    ...
    'index.features.f1_t' => 'Verrous temporels',
    'index.features.f1_d' => 'Créez un temps de réflexion avant de dépenser.',
    'index.features.f2_t' => 'Salles d’épargne',
    'index.features.f2_d' => 'Épargne de groupe avec règles : consensus ou rotation.',
    'index.features.f3_t' => 'Coffre',
    'index.features.f3_d' => 'Votre phrase secrète reste sur votre appareil ; le serveur ne stocke que le ciphertext.',
    'index.features.f4_t' => 'Sauvegardes',
    'index.features.f4_d' => 'Exports chiffrés + instantanés cloud (optionnels).',
    'index.features.f5_t' => 'Notifications',
    'index.features.f5_d' => 'Fenêtres de déverrouillage, événements de salle, alertes de sécurité.',
    'index.features.f6_t' => 'Sécurité',
    'index.features.f6_d' => 'Passkeys, app d’authentification et contrôle des sessions.',
    'index.features.f7_t' => 'Confiance & KYC',
    'index.features.f7_d' => 'Vérification pour les salles à plus haut niveau de confiance et les flux régulés.',
    'index.features.f8_t' => 'Forfaits',
    'index.features.f8_d' => 'Augmentez les limites (verrous, salles, wallets).',
    'index.features.f9_t' => 'Outils admin',
    'index.features.f9_d' => 'Audit, litiges, séquestre — sans accès au texte en clair.',
    ...
    'room.nav.proofs' => 'Preuves',

    'room.proofs_title' => 'Preuves de la salle',
    'room.proofs_sub' => 'Toutes les preuves de contribution (captures) soumises par les participants.',
    'room.proofs_back_to_room' => 'Retour à la salle',
    'room.proofs_table_title' => 'Preuves',
    'room.proofs_empty' => 'Aucune preuve pour le moment.',
    'room.proofs_th_cycle' => 'Cycle',
    'room.proofs_th_participant' => 'Participant',
    'room.proofs_th_amount' => 'Montant',
    'room.proofs_th_status' => 'Statut',
    'room.proofs_th_confirmed' => 'Confirmé',
    'room.proofs_th_proof' => 'Preuve',
    'room.proofs_view' => 'Voir',
    'room.proofs_cycle_fmt' => 'Cycle n°{n}',
    ...
    'room.vote.disabled_already_voted_fmt' => 'Vote déjà enregistré (vous : {vote}).',
    'room.vote.disabled_unavailable' => 'Vote indisponible.',

    'room.rotation.vote_disabled_not_active' => 'Le vote est disponible uniquement lorsque la salle est active.',
    'room.rotation.vote_disabled_not_participant' => 'Seuls les participants actifs peuvent voter.',
    'room.rotation.vote_disabled_not_pending' => 'Le vote n’est pas requis pour le moment.',
    'room.rotation.vote_disabled_role' => 'Votre vote n’est pas requis pour ce tour.',
    'room.rotation.vote_disabled_no_votes_required' => 'Aucun vote des participants n’est requis pour ce tour.',
    'room.rotation.vote_disabled_opens_fmt' => 'Le vote ouvre {ts}.',
    'room.rotation.vote_disabled_closed' => 'La fenêtre de vote est fermée.',
    'room.rotation.vote_disabled_unavailable' => 'Vote indisponible.',
    ...
    'room.rotation.room_balance' => 'Solde de la salle',
    'room.rotation.required_amount' => 'Montant requis',
    ...
    'room.rotation.history_th_collected' => 'Collecté',
    ...
    'room.ov.next_turn_date' => 'Date du prochain tour',
    ...
    'room.state.lobby_open' => 'Lobby (ouvert)',
    'room.state.lobby_locked' => 'Lobby (verrouillé)',
    'room.state.closed' => 'Fermé',
    'room.state.cancelled' => 'Annulé',

    'room.status.invited' => 'Invité',
    'room.status.you_fmt' => 'Vous : {status}',
    'room.status.none' => 'Pas membre',
    'room.status.pending' => 'En attente',
    'room.status.approved' => 'Approuvé',
    'room.status.active' => 'Actif',
    'room.status.declined' => 'Refusé',
    'room.status.removed' => 'Retiré',
    'room.status.completed' => 'Terminé',
    'room.status.exited_prestart' => 'Sorti (avant début)',
    'room.status.exited_poststart' => 'Sorti',
    ...
    'create_code.receive_via_link' => 'Recevoir via lien',
